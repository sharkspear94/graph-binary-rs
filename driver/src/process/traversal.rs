...
impl<'de, E, T> GraphTraversal<E, T> {
    ...
    pub fn id(mut self) -> GraphTraversal<GremlinValue, GremlinValue> {
        self.bytecode.push_new_step("id", vec![]);
        GraphTraversal {
            end: PhantomData,
    ...
    pub fn label(mut self) -> GraphTraversal<String, String> {
        self.bytecode.push_new_step("label", vec![]);
        GraphTraversal::new(self.bytecode)
    }

    pub fn constant<C: Into<GremlinValue> + Deserialize<'de>>(
        mut self,
        constant: C,
    ) -> GraphTraversal<C, C> {
        self.bytecode
            .push_new_step("constant", vec![constant.into()]);
        GraphTraversal::new(self.bytecode)
    }

    pub fn v<A: Into<GremlinValue>>(mut self, a: A) -> GraphTraversal<Vertex, Vertex> {
        self.bytecode.push_new_step("V", vec![a.into()]);
        GraphTraversal::new(self.bytecode)
    }
    ...
    pub fn to_e(
        ...
        self.bytecode.push_new_step("in", vec![direction.into()]);
    ...
    ) -> GraphTraversal<GremlinValue, GremlinValue> {
    ...
    pub fn element_map(
        mut self,
    ) -> GraphTraversal<HashMap<MapKeys, GremlinValue>, HashMap<MapKeys, GremlinValue>> {
        self.bytecode.push_new_step("elementMap", vec![]);
        GraphTraversal::new(self.bytecode)
    }
    ...
    pub fn key(mut self) -> GraphTraversal<String, String> {
        self.bytecode.push_new_step("key", vec![]);
        GraphTraversal::new(self.bytecode)
    }

    pub fn value(mut self) -> Self {
        self.bytecode.push_new_step("value", vec![]);
        self
    }

    pub fn path(mut self) -> GraphTraversal<Path, Path> {
        self.bytecode.push_new_step("path", vec![]);
        GraphTraversal::new(self.bytecode)
    }
    ...
    pub fn match_(
        ...
        self.bytecode
            .push_new_step("match", vec![match_traversal.bytecode.into()]);
        GraphTraversal::new(self.bytecode)
    }

    pub fn sack(mut self, sackparam: impl SackParam) -> GraphTraversal<GremlinValue, GremlinValue> {
    ...
    ) -> GraphTraversal<HashMap<String, GremlinValue>, HashMap<String, GremlinValue>> {
    ...
    pub fn unfold(mut self) -> GraphTraversal<GremlinValue, GremlinValue> {
        self.bytecode.push_new_step("unfold", vec![]);
        GraphTraversal::new(self.bytecode)
    }

    pub fn fold(mut self) -> GraphTraversal<Vec<GremlinValue>, Vec<GremlinValue>> {
        self.bytecode.push_new_step("fold", vec![]);
        GraphTraversal::new(self.bytecode)
    }

    pub fn fold_with_seed<Seed: Into<GremlinValue> + Deserialize<'de>, L: Into<Lambda>>(
        mut self,
        seed: Seed,
        lambda: L,
    ...
    pub fn sum(mut self, scope: impl ScopeParams) -> GraphTraversal<GremlinValue, GremlinValue> {
        //TODO // Num Trait
        scope.bytecode("sum", &mut self.bytecode);
        GraphTraversal::new(self.bytecode)
    }

    pub fn max(mut self, scope: impl ScopeParams) -> GraphTraversal<GremlinValue, GremlinValue> {
        //TODO
        scope.bytecode("max", &mut self.bytecode);
        GraphTraversal::new(self.bytecode)
    }

    pub fn min(mut self, scope: impl ScopeParams) -> GraphTraversal<GremlinValue, GremlinValue> {
        //TODO
        scope.bytecode("min", &mut self.bytecode);
        GraphTraversal::new(self.bytecode)
    }

    pub fn mean(mut self, scope: impl ScopeParams) -> GraphTraversal<GremlinValue, GremlinValue> {
        //TODO
    ...
    pub fn math(mut self, expression: impl AsRef<str>) -> GraphTraversal<f64, f64> {
        self.bytecode
            .push_new_step("math", vec![expression.as_ref().into()]);
        GraphTraversal::new(self.bytecode)
    }

    pub fn element(mut self) -> Self {
        //TODO
        self.bytecode.push_new_step("element", vec![]);
        self
    }
    ...
    pub fn none(mut self) -> Self {
        self.bytecode.push_new_step("none", vec![]);
        self
    }
    ...
    pub fn inject<I: Into<GremlinValue> + Deserialize<'de>>(
        ...
        self.bytecode.push_new_step("inject", vec![items.into()]);
        GraphTraversal::new(self.bytecode)
    }
    ...
    pub fn has_not(mut self, property_key: impl AsRef<str>) -> Self {
        self.bytecode
            .push_new_step("hasNot", vec![property_key.as_ref().into()]);
        self
    }
    ...
    pub fn has_value(
        ...
        self.bytecode.push_new_step("hasValue", vec![value.into()]);
    ...
    pub fn not(mut self, not_traversal: BytecodeTraversal) -> Self {
        self.bytecode
            .push_new_step("not", vec![not_traversal.into()]);
        self
    }

    pub fn coin(mut self, propability: f64) -> Self {
        self.bytecode
            .push_new_step("coin", vec![propability.into()]);
        self
    }
    ...
    pub fn time_limit(mut self, time_limit: i64) {
        self.bytecode
            .push_new_step("timeLimit", vec![time_limit.into()])
    }

    pub fn simple_path(mut self) -> Self {
        self.bytecode.push_new_step("simplePath", vec![]);
        self
    }

    pub fn cyclic_path(mut self) -> Self {
        self.bytecode.push_new_step("cyclicPath", vec![]);
        self
    }
    ...
    pub fn drop(mut self) -> Self {
        self.bytecode.push_new_step("drop", vec![]);
        self
    }
    ...
    pub fn side_effect(mut self, side_effect_traversal: BytecodeTraversal) -> Self {
        //TODO
        self.bytecode
            .push_new_step("sideEffect", vec![side_effect_traversal.into()]);
        self
    }
    ...
    pub fn cap(
        ...
        self.bytecode
            .push_new_step("cap", vec![side_effect_key.as_ref().into()]);
    ...
    pub fn subgraph(mut self, side_effect_key: impl AsRef<str>) -> Self {
        self.bytecode
            .push_new_step("subgraph", vec![side_effect_key.as_ref().into()]);
        self
    }
    ...
    pub fn optional(mut self, optional_traversel: BytecodeTraversal) -> Self {
        self.bytecode
            .push_new_step("optional", vec![optional_traversel.into()]);
        self
    }

    pub fn union(mut self, union_traversal: BytecodeTraversal) -> Self {
        self.bytecode
            .push_new_step("union", vec![union_traversal.into()]);
        self
    }
    ...
    pub fn times(mut self, max_loops: i32) -> Self {
        self.bytecode.push_new_step("times", vec![max_loops.into()]);
        self
    }
    ...
    pub fn local(
        ...
        self.bytecode
            .push_new_step("local", vec![local_traversal.into()]);
        GraphTraversal::new(self.bytecode)
    }
    ...
    pub fn peer_pressure(mut self) -> Self {
        self.bytecode.push_new_step("peerPressure", vec![]);
        self
    }

    pub fn connected_component(mut self) -> Self {
        self.bytecode.push_new_step("connectedComponent", vec![]);
        self
    }

    pub fn shortest_path(mut self) -> Self {
        self.bytecode.push_new_step("shortestPath", vec![]);
        self
    }
    ...
    pub fn as_(mut self, step_label: impl AsRef<str>, step_labels: impl MultiStringParams) -> Self {
        self.bytecode
            .push_new_step("as", vec![step_label.as_ref().into()]);
    ...
    pub fn index(mut self) -> Self {
        self.bytecode.push_new_step("index", vec![]);
        self
    }

    pub fn with(mut self, key: impl AsRef<str>, object: impl ObjectParam) -> Self {
        self.bytecode
            .push_new_step("with", vec![key.as_ref().into()]);
    ...
    pub fn read(mut self) -> Self {
        self.bytecode.push_new_step("read", vec![]);
        self
    }

    pub fn write(mut self) -> Self {
        self.bytecode.push_new_step("write", vec![]);
        self
    }
...
impl<E, T> From<GraphTraversal<E, T>> for GremlinValue {
    fn from(g: GraphTraversal<E, T>) -> Self {
        GremlinValue::Bytecode(g.bytecode)
    }
}
...
impl From<Id> for GremlinValue {
    fn from(id: Id) -> Self {
        match id {
            Id::String(s) => GremlinValue::String(s),
            Id::Int(v) => GremlinValue::Int(v),
            Id::Long(v) => GremlinValue::Long(v),
            Id::Uuid(v) => GremlinValue::Uuid(v),
        }
    }
}
...
impl From<Ids> for Vec<GremlinValue> {
...
impl AnonymousTraversal {
    pub fn id(&self) -> BytecodeTraversal {
        ...
        bc.push_new_step("id", vec![]);
        BytecodeTraversal::new(bc)
    }

    pub fn label(&self) -> BytecodeTraversal {
        let mut bc = Bytecode::default();
        bc.push_new_step("label", vec![]);
        BytecodeTraversal::new(bc)
    }

    pub fn constant<C: Into<GremlinValue>>(&self, constant: C) -> BytecodeTraversal {
        let mut bc = Bytecode::default();
        bc.push_new_step("constant", vec![constant.into()]);
        BytecodeTraversal::new(bc)
    }

    pub fn v(&self) -> BytecodeTraversal {
        let mut bc = Bytecode::default();
        bc.push_new_step("V", vec![]);
        BytecodeTraversal::new(bc)
    }

    pub fn e(&self) -> BytecodeTraversal {
        let mut bc = Bytecode::default();
        bc.push_new_step("E", vec![]);
        BytecodeTraversal::new(bc)
    }
    ...
    pub fn to_e(&self, direction: Direction, labels: impl MultiStringParams) -> BytecodeTraversal {
        let mut bc = Bytecode::default();
        bc.push_new_step("in", vec![direction.into()]);
    ...
    pub fn project(
        ...
        let mut bc = Bytecode::default();
        bc.push_new_step("project", vec![property_key.as_ref().into()]);
    ...
    pub fn unfold(&self) -> BytecodeTraversal {
        let mut bc = Bytecode::default();
        bc.push_new_step("unfold", vec![]);
        BytecodeTraversal::new(bc)
    }

    pub fn fold(&self) -> BytecodeTraversal {
        let mut bc = Bytecode::default();
        bc.push_new_step("fold", vec![]);
        BytecodeTraversal::new(bc)
    }
    ...
    pub fn fold_with_seed<E2: Into<GremlinValue>, L: Into<Lambda>>(
        ...
        let mut bc = Bytecode::default();
        bc.push_new_step("fold", vec![seed.into(), lambda.into().into()]);
        BytecodeTraversal::new(bc)
    }
    ...
    pub fn math(&self, expression: impl AsRef<str>) -> BytecodeTraversal {
        let mut bc = Bytecode::default();
        bc.push_new_step("math", vec![expression.as_ref().into()]);
        BytecodeTraversal::new(bc)
    }
    ...
    pub fn inject<I: Into<GremlinValue>>(&self, items: I) -> BytecodeTraversal {
        let mut bc = Bytecode::default();
        bc.push_new_step("inject", vec![items.into()]);
        BytecodeTraversal::new(bc)
    }
    ...
    pub fn has_not(&self, property_key: impl AsRef<str>) -> BytecodeTraversal {
        let mut bc = Bytecode::default();
        bc.push_new_step("hasNot", vec![property_key.as_ref().into()]);
        BytecodeTraversal::new(bc)
    }
    ...
    pub fn has_value(
        ...
        let mut bc = Bytecode::default();
        bc.push_new_step("hasValue", vec![value.into()]);
    ...
    pub fn not(&self, not_traversal: BytecodeTraversal) -> BytecodeTraversal {
        let mut bc = Bytecode::default();
        bc.push_new_step("not", vec![not_traversal.into()]);
        BytecodeTraversal::new(bc)
    }

    pub fn coin(&self, propability: f64) -> BytecodeTraversal {
        let mut bc = Bytecode::default();
        bc.push_new_step("coin", vec![propability.into()]);
        BytecodeTraversal::new(bc)
    }
    ...
    pub fn time_limit(&self, time_limit: i64) {
        let mut bc = Bytecode::default();
        bc.push_new_step("timeLimit", vec![time_limit.into()])
    }

    pub fn simple_path(&self) -> BytecodeTraversal {
        let mut bc = Bytecode::default();
        bc.push_new_step("simplePath", vec![]);
        BytecodeTraversal::new(bc)
    }

    pub fn cyclic_path(&self) -> BytecodeTraversal {
        let mut bc = Bytecode::default();
        bc.push_new_step("cyclicPath", vec![]);
        BytecodeTraversal::new(bc)
    }
    ...
    pub fn side_effect(&self, side_effect_traversal: BytecodeTraversal) -> BytecodeTraversal {
        let mut bc = Bytecode::default();
        //TODO
        bc.push_new_step("sideEffect", vec![side_effect_traversal.into()]);
        BytecodeTraversal::new(bc)
    }
    ...
    pub fn cap(
        ...
        let mut bc = Bytecode::default();
        bc.push_new_step("cap", vec![side_effect_key.as_ref().into()]);
    ...
    pub fn subgraph(&self, side_effect_key: impl AsRef<str>) -> BytecodeTraversal {
        let mut bc = Bytecode::default();
        bc.push_new_step("subgraph", vec![side_effect_key.as_ref().into()]);
        BytecodeTraversal::new(bc)
    }
    ...
    pub fn optional<E2>(&self, optional_traversel: BytecodeTraversal) -> BytecodeTraversal {
        let mut bc = Bytecode::default();
        bc.push_new_step("optional", vec![optional_traversel.into()]);
        BytecodeTraversal::new(bc)
    }

    pub fn union(&self, union_traversal: BytecodeTraversal) -> BytecodeTraversal {
        let mut bc = Bytecode::default();
        bc.push_new_step("union", vec![union_traversal.into()]);
        BytecodeTraversal::new(bc)
    }
    ...
    pub fn times(&self, max_loops: i32) -> BytecodeTraversal {
        let mut bc = Bytecode::default();
        bc.push_new_step("times", vec![max_loops.into()]);
        BytecodeTraversal::new(bc)
    }

    pub fn local<E2>(&self, local_traversal: BytecodeTraversal) -> BytecodeTraversal {
        let mut bc = Bytecode::default();
        bc.push_new_step("local", vec![local_traversal.into()]);
        BytecodeTraversal::new(bc)
    }
    ...
    pub fn peer_pressure(&self) -> BytecodeTraversal {
        let mut bc = Bytecode::default();
        bc.push_new_step("peerPressure", vec![]);
        BytecodeTraversal::new(bc)
    }
    ...
    pub fn shortest_path(&self) -> BytecodeTraversal {
        let mut bc = Bytecode::default();
        bc.push_new_step("shortestPath", vec![]);
        BytecodeTraversal::new(bc)
    }
    ...
    pub fn as_(
        ...
        let mut bc = Bytecode::default();
        bc.push_new_step("as", vec![step_label.as_ref().into()]);
    ...
    pub fn read(&self) -> BytecodeTraversal {
        let mut bc = Bytecode::default();
        bc.push_new_step("read", vec![]);
        BytecodeTraversal::new(bc)
    }

    pub fn write(&self) -> BytecodeTraversal {
        let mut bc = Bytecode::default();
        bc.push_new_step("write", vec![]);
        BytecodeTraversal::new(bc)
    }
...
fn test1() {
    ...
    let t = g.v(()).is(Vertex::new(1, "person", None));
